...
#pragma pack()
/******************************************************************************/
DKEXTERN struct DoorDesc _DK_doors[TORTURE_DOORS_COUNT];
#define doors _DK_doors
DKEXTERN struct TbSprite *_DK_fronttor_sprites;
#define fronttor_sprites _DK_fronttor_sprites
DKEXTERN struct TbSprite *_DK_fronttor_end_sprites;
#define fronttor_end_sprites _DK_fronttor_end_sprites
DKEXTERN unsigned char *_DK_fronttor_data;
#define fronttor_data _DK_fronttor_data
DKEXTERN unsigned char * _DK_fronttor_end_data;
