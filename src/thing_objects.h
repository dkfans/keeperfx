...
enum ObjectModels
{
    ...
    ObjMdl_GuardFlagPurple = 163,
    ObjMdl_HeartFlamePurple = 164,
    ObjMdl_GuardFlagBlack = 165,
    ObjMdl_HeartFlameBlack = 166,
    ObjMdl_GuardFlagOrange = 167,
    ObjMdl_HeartFlameOrange = 168,
};
