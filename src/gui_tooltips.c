...
void setup_gui_tooltip(struct GuiButton *gbtn)
{
    ...
    else if ((i == get_power_description_strindex(PwrK_CHICKEN)) && (dungeon->chickens_sacrificed > 16)) // Chicken spell tooltip easter egg
    {
        set_gui_tooltip_box_fmt(0, "%s", jtytext);
    }
    else if (i == GUIStr_PickCreatrMostExpDesc)
    {
