...
static int map_set_field(lua_State *L) {
    ...
    if (strcmp(key, "default_texture") == 0) {
        ...
        load_texture_map_file(texture_id, get_loaded_level_number(), FGrp_FxData);
        return 0;
    }
