    ...
    MapSlabCoord cursor_x, MapSlabCoord cursor_y, short rkind_cost, int total_player_money, int mode, int roomspace_discovery_looseness)
{
    ...
    struct RoomSpace best_room = { {{false}}, 1, true, 1, 1, cursor_x, cursor_y, cursor_x, cursor_y, cursor_x, cursor_y, rkind_cost, 0, plyr_idx, -1 /*user*/, rkind, false, 0, 0, false, true, false, false, false, false, 0, 0, 0, 0, false, top_left_to_bottom_right };
