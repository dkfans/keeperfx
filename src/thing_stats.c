...
long compute_creature_kind_score(ThingModel crkind, unsigned short crlevel)
{
    ...
    return compute_creature_max_health(crstat->health, crlevel) + compute_creature_max_defense(crstat->defense, crlevel) + compute_creature_max_dexterity(crstat->dexterity, crlevel) + compute_creature_max_armour(crstat->armour, crlevel, false) + compute_creature_max_strength(crstat->strength, crlevel);
}
