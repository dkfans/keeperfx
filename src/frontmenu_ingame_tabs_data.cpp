...
struct GuiButtonInit trap_menu_buttons[] = {
  {LbBtnT_NormalBtn, BID_MNFCT_TD02, 0, 0, gui_choose_trap,gui_go_to_next_trap,gui_over_trap_button,0, 2,238,  6, 242, 32, 36, gui_area_trap_button,            154, CpgStr_AlarmTrapDesc,     0,       {2},               0, maintain_trap },
  {LbBtnT_NormalBtn, BID_MNFCT_TD03, 0, 0, gui_choose_trap,gui_go_to_next_trap,gui_over_trap_button,0,34,238, 38, 242, 32, 36, gui_area_trap_button,            156, CpgStr_PoisonGasTrapDesc, 0,       {3},               0, maintain_trap },
  {LbBtnT_NormalBtn, BID_MNFCT_TD04, 0, 0, gui_choose_trap,gui_go_to_next_trap,gui_over_trap_button,0,66,238, 70, 242, 32, 36, gui_area_trap_button,            158, CpgStr_LightningTrapDesc, 0,       {4},               0, maintain_trap },
  {LbBtnT_NormalBtn, BID_MNFCT_TD15, 0, 0, gui_choose_trap,gui_go_to_next_trap,gui_over_trap_button,0,98,238,102, 242, 32, 36, gui_area_trap_button,            162, CpgStr_LavaTrapDesc,      0,       {6},               0, maintain_trap },
  {LbBtnT_NormalBtn, BID_MNFCT_TD01, 0, 0, gui_choose_trap,gui_go_to_next_trap,gui_over_trap_button,0, 2,276,  6, 280, 32, 36, gui_area_trap_button,            152, CpgStr_TrapBoulderDesc,   0,       {1},               0, maintain_trap },
  {LbBtnT_NormalBtn, BID_MNFCT_TD05, 0, 0, gui_choose_trap,gui_go_to_next_trap,gui_over_trap_button,0,34,276, 38, 280, 32, 36, gui_area_trap_button,            160, CpgStr_WordOfPowerTrapDesc,0,      {5},               0, maintain_trap },
  {LbBtnT_NormalBtn, BID_MNFCT_TD11, 0, 0, NULL,               NULL,        NULL,               0,  66, 276,  70, 280, 32, 36, gui_area_new_null_button,         24, GUIStr_Empty,             0,       {0},               0, NULL },
  {LbBtnT_NormalBtn, BID_MNFCT_TD12, 0, 0, NULL,               NULL,        NULL,               0,  98, 276, 102, 280, 32, 36, gui_area_new_null_button,         24, GUIStr_Empty,             0,       {0},               0, NULL },
  {LbBtnT_NormalBtn, BID_MNFCT_TD06, 0, 0, gui_choose_trap,gui_go_to_next_door,gui_over_door_button,0, 2,314,  6, 318, 32, 36, gui_area_trap_button,            166, CpgStr_WoodenDoorDesc,    0,       {7},               0, maintain_door },
  {LbBtnT_NormalBtn, BID_MNFCT_TD07, 0, 0, gui_choose_trap,gui_go_to_next_door,gui_over_door_button,0,34,314, 38, 318, 32, 36, gui_area_trap_button,            168, CpgStr_BracedDoorDesc,    0,       {8},               0, maintain_door },
  {LbBtnT_NormalBtn, BID_MNFCT_TD08, 0, 0, gui_choose_trap,gui_go_to_next_door,gui_over_door_button,0,66,314, 70, 318, 32, 36, gui_area_trap_button,            170, CpgStr_IronDoorDesc,      0,       {9},               0, maintain_door },
  {LbBtnT_NormalBtn, BID_MNFCT_TD09, 0, 0, gui_choose_trap,gui_go_to_next_door,gui_over_door_button,0,98,314,102, 318, 32, 36, gui_area_trap_button,            172, CpgStr_MagicDoorDesc,     0,      {10},               0, maintain_door },
...
struct GuiButtonInit creature_query_buttons3[] = {
  ...
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,   4, 226,   4, 226, 60, 24, gui_area_stat_button,            331, GUIStr_CreatureKillsDesc,      0,          {CrLStat_Kills}, 0, NULL },
  ...
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,   4, 256,   4, 256, 60, 24, gui_area_stat_button,            333, GUIStr_CreatureGoldHeldDesc,   0,       {CrLStat_GoldHeld}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,  72, 256,  72, 256, 60, 24, gui_area_stat_button,            334, GUIStr_CreatureWageDesc,       0,       {CrLStat_GoldWage}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,   4, 286,   4, 286, 60, 24, gui_area_stat_button,            335, GUIStr_CreatureArmourDesc,     0,         {CrLStat_Armour}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,  72, 286,  72, 286, 60, 24, gui_area_stat_button,            338, GUIStr_CreatureDefenceDesc,    0,        {CrLStat_Defence}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,   4, 316,   4, 316, 60, 24, gui_area_stat_button,            339, GUIStr_CreatureLuckDesc,       0,           {CrLStat_Luck}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,  72, 316,  72, 316, 60, 24, gui_area_stat_button,            337, GUIStr_CreatureDexterityDesc,  0,      {CrLStat_Dexterity}, 0, NULL },
...
struct GuiButtonInit creature_query_buttons4[] = {
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 1, NULL,               NULL,        NULL,               0,  44, 374,  44, 374, 52, 20, gui_area_new_normal_button,      473, GUIStr_MoreInformation,&creature_query_menu1,           {0}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,   4, 226,   4, 226, 60, 24, gui_area_stat_button,            340, GUIStr_CreatureSpeedDesc,       0,          {CrLStat_Speed}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,  72, 226,  72, 226, 60, 24, gui_area_stat_button,            340, GUIStr_CreatureLoyaltyDesc,     0,        {CrLStat_Loyalty}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,   4, 256,   4, 256, 60, 24, gui_area_stat_button,            340, GUIStr_CreatureResrchSkillDesc, 0,  {CrLStat_ResearchSkill}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,  72, 256,  72, 256, 60, 24, gui_area_stat_button,            340, GUIStr_CreatureManfctrSkillDesc,0,{CrLStat_ManufactureSkill},0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,   4, 286,   4, 286, 60, 24, gui_area_stat_button,            340, GUIStr_CreatureTraingSkillDesc, 0,  {CrLStat_TrainingSkill}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,  72, 286,  72, 286, 60, 24, gui_area_stat_button,            340, GUIStr_CreatureScavngSkillDesc, 0,  {CrLStat_ScavengeSkill}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,   4, 316,   4, 316, 60, 24, gui_area_stat_button,            340, GUIStr_CreatureTraingCostDesc,  0,   {CrLStat_TrainingCost}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,  72, 316,  72, 316, 60, 24, gui_area_stat_button,            340, GUIStr_CreatureScavngCostDesc,  0,   {CrLStat_ScavengeCost}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,   4, 346,   4, 346, 60, 24, gui_area_stat_button,            340, GUIStr_CreatureWeightDesc,      0,         {CrLStat_Weight}, 0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,  72, 346,  72, 346, 60, 24, gui_area_stat_button,            340, GUIStr_CreatureScoreDesc,       0,          {CrLStat_Score}, 0, NULL },
  {              -1,    BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,   0,   0,   0,   0,  0,  0, NULL,                              0,   0,                            0,                      {0}, 0, NULL },
};
