...
static int64_t value_creatures_list(const struct NamedField* named_field, const char* value_text, const struct NamedFieldSet* named_fields_set, int idx, const char* src_str, unsigned char flags)
{
    ...
    while (get_conf_parameter_single(value_text,&pos,len,word_buf,sizeof(word_buf)) > 0)
    {
      ...
      {
        NAMFIELDWRNLOG("Too many species defined with \"%s\" in [%s] block of %s file.",
...
static const struct NamedField creaturetype_common_named_fields[] = {
    {"CREATURES",   -1, field(game.conf.crtr_conf.model[0].name),   0,    0,      0, creature_desc,  value_creatures_list, assign_null},
    {"SPRITESIZE",   0, field(game.conf.crtr_conf.sprite_size),   300,    0,      0,          NULL,  value_default,        assign_default},
    {NULL},
};
...
const struct NamedFieldSet creaturetype_common_named_fields_set = {
    NULL,
    "common",
    creaturetype_common_named_fields,
    NULL,
    0,
...
static const struct NamedField creaturetype_experience_named_fields[] = {
    {"PAYINCREASEONEXP",            0, field(game.conf.crtr_conf.exp.pay_increase_on_exp            ),   CREATURE_PROPERTY_INCREASE_ON_EXP,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"SPELLDAMAGEINCREASEONEXP",    0, field(game.conf.crtr_conf.exp.spell_damage_increase_on_exp   ),   CREATURE_PROPERTY_INCREASE_ON_EXP,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"RANGEINCREASEONEXP",          0, field(game.conf.crtr_conf.exp.range_increase_on_exp          ),   CREATURE_PROPERTY_INCREASE_ON_EXP,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"JOBVALUEINCREASEONEXP",       0, field(game.conf.crtr_conf.exp.job_value_increase_on_exp      ),   CREATURE_PROPERTY_INCREASE_ON_EXP,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"HEALTHINCREASEONEXP",         0, field(game.conf.crtr_conf.exp.health_increase_on_exp         ),   CREATURE_PROPERTY_INCREASE_ON_EXP,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"STRENGTHINCREASEONEXP",       0, field(game.conf.crtr_conf.exp.strength_increase_on_exp       ),   CREATURE_PROPERTY_INCREASE_ON_EXP,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"DEXTERITYINCREASEONEXP",      0, field(game.conf.crtr_conf.exp.dexterity_increase_on_exp      ),   CREATURE_PROPERTY_INCREASE_ON_EXP,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"DEFENSEINCREASEONEXP",        0, field(game.conf.crtr_conf.exp.defense_increase_on_exp        ),   CREATURE_PROPERTY_INCREASE_ON_EXP,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"LOYALTYINCREASEONEXP",        0, field(game.conf.crtr_conf.exp.loyalty_increase_on_exp        ),   CREATURE_PROPERTY_INCREASE_ON_EXP,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"ARMOURINCREASEONEXP",         0, field(game.conf.crtr_conf.exp.armour_increase_on_exp         ),                                   0,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"SIZEINCREASEONEXP",           0, field(game.conf.crtr_conf.exp.size_increase_on_exp           ),                                   0,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"EXPFORHITTINGINCREASEONEXP",  0, field(game.conf.crtr_conf.exp.exp_on_hitting_increase_on_exp ),   CREATURE_PROPERTY_INCREASE_ON_EXP,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"TRAININGCOSTINCREASEONEXP",   0, field(game.conf.crtr_conf.exp.training_cost_increase_on_exp  ),                                   0,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {"SCAVENGINGCOSTINCREASEONEXP", 0, field(game.conf.crtr_conf.exp.scavenging_cost_increase_on_exp),                                   0,    INT32_MIN, UINT32_MAX, NULL,  value_default, assign_default},
    {NULL},
};
...
const struct NamedFieldSet creaturetype_experience_named_fields_set = {
    NULL,
    "experience",
    creaturetype_experience_named_fields,
    NULL,
    0,
    0,
    NULL,
...
static const struct NamedField creaturetype_angerjob_named_fields[] = {
    {"NAME",   0, field(game.conf.crtr_conf.states[0].name), 0,        0,      0, creatrstate_desc,  value_flagname,      assign_null},
    {NULL},
};

const struct NamedFieldSet creaturetype_angerjob_named_fields_set = {
    &game.conf.crtr_conf.angerjobs_count,
    "angerjob",
    creaturetype_angerjob_named_fields,
    angerjob_desc,
    INSTANCE_TYPES_MAX,
    sizeof(game.conf.crtr_conf.angerjobs[0]),
    game.conf.crtr_conf.angerjobs,
};

static const struct NamedField crstates_states_named_fields[] = {
    {"NAME",   0, field(game.conf.crtr_conf.attacktypes[0].name), 0,        0,      0, attackpref_desc,  value_name,      assign_null},
    {NULL},
};

const struct NamedFieldSet creaturetype_attackpref_named_fields_set = {
    &game.conf.crtr_conf.attacktypes_count,
    "attackpref",
    creaturetype_attackpref_named_fields,
    attackpref_desc,
    INSTANCE_TYPES_MAX,
    sizeof(game.conf.crtr_conf.attacktypes[0]),
    game.conf.crtr_conf.attacktypes,
};
