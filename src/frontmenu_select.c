...
void frontend_draw_level_select_button(struct GuiButton *gbtn)
{
    ...
    else if (get_level_highest_score(lvnum))
    {
        i = 3;
    }
    else
...
void frontend_level_select_update(void)
{
    ...
    else if (select_level_scroll_offset < 0)
    {
        select_level_scroll_offset = 0;
    }
    else if (select_level_scroll_offset > number_of_freeplay_levels - frontend_select_level_items_visible + 1)
    {
...
void frontend_campaign_select_update(void)
{
    ...
    else if (select_campaign_scroll_offset < 0)
    {
        select_campaign_scroll_offset = 0;
    }
    else if (select_campaign_scroll_offset > campaigns_list.items_num - frontend_select_campaign_items_visible + 1)
    {
...
void frontend_mappack_select_update(void)
{
    ...
    else if (select_mappack_scroll_offset < 0)
    {
        select_mappack_scroll_offset = 0;
    }
    else if (select_mappack_scroll_offset > mappacks_list.items_num - frontend_select_mappack_items_visible + 1)
    {
