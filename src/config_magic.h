...
enum ShotModelFlags {
    ...
    ShMF_Slappable      = 0x00000001,
    ShMF_Navigable      = 0x00000002,
    ShMF_Boulder        = 0x00000004,
    ShMF_ReboundImmune  = 0x00000008,
    ShMF_Digging        = 0x00000010,
    ShMF_LifeDrain      = 0x00000020,
    ShMF_GroupUp        = 0x00000040,
    ShMF_NoStun         = 0x00000080,
    ShMF_NoHit          = 0x00000100,
    ShMF_StrengthBased  = 0x00000200,
    ShMF_AlarmsUnits    = 0x00000400,
    ShMF_CanCollide     = 0x00000800,
    ShMF_Disarming      = 0x00001000,
    ShMF_Exploding      = 0x00002000,
    ShMF_BlocksRebirth  = 0x00004000,
    ShMF_Penetrating    = 0x00008000,
    ShMF_InstantHit     = 0x00010000,
};
