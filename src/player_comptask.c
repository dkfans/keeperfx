            ...
            case TDSC_DoorCrate:
                ...
                if (dungeon->mnfct_info.door_amount_placeable[model] > 0)
                {
                    ...
                    case WrkCrtS_Offmap:
                        ...
                        item_sold = true;
                        value = compute_value_percentage(game.conf.doors_config[model].selling_value,game.conf.rules.door_sale_percent);
            ...
            case TDSC_TrapCrate:
                ...
                if ((dungeon->mnfct_info.trap_amount_placeable[model] > 0) && (trapst->unsellable == 0))
                {
                    ...
                    case WrkCrtS_Offmap:
                        ...
                        item_sold = true;
                        value = compute_value_percentage(game.conf.traps_config[model].selling_value, game.conf.rules.trap_sale_percent);
