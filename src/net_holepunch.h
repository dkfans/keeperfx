...
int holepunch_handle_packet(struct _ENetHost *host, struct _ENetAddress *expected, const struct _ENetAddress *advertised, size_t expected_count, int *received_mask);
