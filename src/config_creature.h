...
struct CreatureJobConfig {
    ...
    Creature_Job_Player_Check_Func func_plyr_check_idx;
    Creature_Job_Player_Assign_Func func_plyr_assign;
    Creature_Job_Player_Assign_Func func_plyr_assign_idx;
    Creature_Job_Coords_Check_Func func_cord_check;
    Creature_Job_Coords_Check_Func func_cord_check_idx;
    Creature_Job_Coords_Assign_Func func_cord_assign;
    Creature_Job_Coords_Assign_Func func_cord_assign_idx;
    RoomRole room_role;
