...
long computer_event_check_imps_in_danger(struct Computer2 *comp, struct ComputerEvent *cevent)
{
    ...
    while (i != 0)
    {
        ...
        {
            if (!creature_is_being_unconscious(creatng) && !creature_affected_with_spell_flags(creatng, CSAfF_Chicken))
            {
                ...
                && !creature_affected_with_spell_flags(creatng, CSAfF_Invisibility)
