...
static const struct NamedField objects_named_fields[] = {
    ...
    {"ANIMATIONID",              0, field(game.conf.object_conf.object_cfgstats[0].sprite_anim_idx),               0, LONG_MIN,ULONG_MAX, NULL,                        value_animid,    assign_default},
    ...
    {"FLAMEANIMATIONID",         0, field(game.conf.object_conf.object_cfgstats[0].flame.animation_id),            0, LONG_MIN,ULONG_MAX, NULL,                        value_animid,    assign_default},
