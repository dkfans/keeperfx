...
struct GuiButtonInit frontend_option_buttons[] = {
  ...
  {LbBtnT_HorizSlider,BID_SOUND_VOL,0,0, gui_set_sound_volume,NULL,       NULL,               0, 144, 147, 144, 147,180, 22, frontend_draw_slider,              0, GUIStr_Empty,  0,{.ptr = &sound_level_slider}, 127, NULL },
  {LbBtnT_HorizSlider,BID_DEFAULT, 0, 0, gui_set_music_volume,NULL,       NULL,               0, 144, 187, 144, 187,180, 22, frontend_draw_slider,              0, GUIStr_Empty,  0,{.ptr = &music_level_slider}, 127, NULL },
  {LbBtnT_NormalBtn,  BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0, 346, 136, 346, 136, 26, 32, frontend_draw_icon,               95, GUIStr_Empty,  0,       {0},            0, NULL },
  {LbBtnT_HorizSlider,BID_DEFAULT, 0, 0, gui_set_mentor_volume,NULL,      NULL,               0, 364, 147, 364, 147,180, 22, frontend_draw_slider,              0, GUIStr_Empty,  0,{.ptr = &mentor_level_slider}, 127, NULL },
  ...
  {LbBtnT_HorizSlider,BID_DEFAULT, 0, 0, frontend_set_mouse_sensitivity,NULL,NULL,            0, 304, 271, 304, 271,190, 22, frontend_draw_small_slider,        0, GUIStr_Empty,  0,{.ptr = &fe_mouse_sensitivity}, 7, NULL },
