...
static const struct NamedField terrain_slab_named_fields[] = {
    ...
    {"NAME",              0, field(game.conf.slab_conf.slab_cfgstats[0].code_name),                     0, LONG_MIN,UINT32_MAX, slab_desc,     value_name,       assign_null},
    {"TOOLTIPTEXTID",     0, field(game.conf.slab_conf.slab_cfgstats[0].tooltip_stridx),     GUIStr_Empty, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"BLOCKFLAGSHEIGHT",  0, field(game.conf.slab_conf.slab_cfgstats[0].block_flags_height),            0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"BLOCKHEALTHINDEX",  0, field(game.conf.slab_conf.slab_cfgstats[0].block_health_index),            0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"BLOCKFLAGS",       -1, field(game.conf.slab_conf.slab_cfgstats[0].block_flags),                   0, LONG_MIN,UINT32_MAX, terrain_flags, value_flagsfield, assign_default},
    {"NOBLOCKFLAGS",     -1, field(game.conf.slab_conf.slab_cfgstats[0].noblck_flags),                  0, LONG_MIN,UINT32_MAX, terrain_flags, value_flagsfield, assign_default},
    {"FILLSTYLE",         0, field(game.conf.slab_conf.slab_cfgstats[0].fill_style),                    0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"CATEGORY",          0, field(game.conf.slab_conf.slab_cfgstats[0].category),                      0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"SLBID",             0, field(game.conf.slab_conf.slab_cfgstats[0].slb_id),                        0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"WIBBLE",            0, field(game.conf.slab_conf.slab_cfgstats[0].wibble),                        0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"ISSAFELAND",        0, field(game.conf.slab_conf.slab_cfgstats[0].is_safe_land),                  0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"ISDIGGABLE",        0, field(game.conf.slab_conf.slab_cfgstats[0].is_diggable),                   0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"WLBTYPE",           0, field(game.conf.slab_conf.slab_cfgstats[0].wlb_type),                      0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"ANIMATED",          0, field(game.conf.slab_conf.slab_cfgstats[0].animated),                      0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"ISOWNABLE",         0, field(game.conf.slab_conf.slab_cfgstats[0].is_ownable),                    0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"INDESTRUCTIBLE",    0, field(game.conf.slab_conf.slab_cfgstats[0].indestructible),                0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {"GOLDHELD",          0, field(game.conf.slab_conf.slab_cfgstats[0].gold_held),                     0, LONG_MIN,UINT32_MAX, NULL,          value_default,    assign_default},
    {NULL},
};
...
static const struct NamedField terrain_room_named_fields[] = {
    ...
    {"NAME",              0, field(game.conf.slab_conf.room_cfgstats[0].code_name),                     0, LONG_MIN,UINT32_MAX,      room_desc,                            value_name,      assign_null},
    {"COST",              0, field(game.conf.slab_conf.room_cfgstats[0].cost),                          0, LONG_MIN,UINT32_MAX,      NULL,                                 value_default,   assign_default},
    {"HEALTH",            0, field(game.conf.slab_conf.room_cfgstats[0].health),                        0, LONG_MIN,UINT32_MAX,      NULL,                                 value_default,   assign_default},
    ...
    {"SLABASSIGN",        0, field(game.conf.slab_conf.room_cfgstats[0].assigned_slab),                 0, LONG_MIN,UINT32_MAX,      slab_desc,                            value_default,   assign_default},
    {"CREATURECREATION",  0, field(game.conf.slab_conf.room_cfgstats[0].creature_creation_model),       0, LONG_MIN,UINT32_MAX,      creature_desc,                        value_default,   assign_default},
    {"MESSAGES",          0, field(game.conf.slab_conf.room_cfgstats[0].msg_needed),                    0, LONG_MIN,UINT32_MAX,      NULL,                                 value_default,   assign_default},
    {"MESSAGES",          1, field(game.conf.slab_conf.room_cfgstats[0].msg_too_small),                 0, LONG_MIN,UINT32_MAX,      NULL,                                 value_default,   assign_default},
    {"MESSAGES",          2, field(game.conf.slab_conf.room_cfgstats[0].msg_no_route),                  0, LONG_MIN,UINT32_MAX,      NULL,                                 value_default,   assign_default},
    {"NAMETEXTID",        0, field(game.conf.slab_conf.room_cfgstats[0].name_stridx),        GUIStr_Empty, LONG_MIN,UINT32_MAX,      NULL,                                 value_default,   assign_default},
    {"TOOLTIPTEXTID",     0, field(game.conf.slab_conf.room_cfgstats[0].tooltip_stridx),     GUIStr_Empty, LONG_MIN,UINT32_MAX,      NULL,                                 value_default,   assign_update_room_tab},
    {"SYMBOLSPRITES",     0, field(game.conf.slab_conf.room_cfgstats[0].bigsym_sprite_idx),             0, LONG_MIN,UINT32_MAX,      NULL,                                 value_icon,      assign_icon},
    {"SYMBOLSPRITES",     1, field(game.conf.slab_conf.room_cfgstats[0].medsym_sprite_idx),             0, LONG_MIN,UINT32_MAX,      NULL,                                 value_icon,      assign_icon_update_room_tab},
    {"POINTERSPRITES",    0, field(game.conf.slab_conf.room_cfgstats[0].pointer_sprite_idx),            0, LONG_MIN,UINT32_MAX,      NULL,                                 value_icon,      assign_icon_update_room_tab},
    {"PANELTABINDEX",     0, field(game.conf.slab_conf.room_cfgstats[0].panel_tab_idx),                 0,        0,       32,      NULL,                                 value_default,   assign_update_room_tab},
    {"TOTALCAPACITY",     0, field(game.conf.slab_conf.room_cfgstats[0].update_total_capacity_idx),     0, LONG_MIN,UINT32_MAX,      terrain_room_total_capacity_func_type,value_default,   assign_reinitialise_rooms},
    {"USEDCAPACITY",      0, field(game.conf.slab_conf.room_cfgstats[0].update_storage_in_room_idx),    0, LONG_MIN,UINT32_MAX,      terrain_room_used_capacity_func_type, value_default,   assign_default},
    {"USEDCAPACITY",      1, field(game.conf.slab_conf.room_cfgstats[0].update_workers_in_room_idx),    0, LONG_MIN,UINT32_MAX,      terrain_room_used_capacity_func_type, value_default,   assign_reinitialise_rooms},
    {"SLABSYNERGY",       0, field(game.conf.slab_conf.room_cfgstats[0].synergy_slab),                  0, LONG_MIN,UINT32_MAX,      slab_desc,                            value_synergy,   assign_recalculate_effeciency},
    {"AMBIENTSNDSAMPLE",  0, field(game.conf.slab_conf.room_cfgstats[0].ambient_snd_smp_id),            0, LONG_MIN,UINT32_MAX,      NULL,                                 value_default,   assign_default},
    {"ROLES",            -1, field(game.conf.slab_conf.room_cfgstats[0].roles),                         0, LONG_MIN,UINT32_MAX,      room_roles_desc,                      value_flagsfield,assign_default},
    {"STORAGEHEIGHT",     0, field(game.conf.slab_conf.room_cfgstats[0].storage_height),                0, LONG_MIN,UINT32_MAX,      NULL,                                 value_default,   assign_default},
    {NULL},
};
