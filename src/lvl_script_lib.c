...
const char *script_variable_labels[SCRIPT_VAR_ENUM_COUNT] = {
    [SVar_MONEY]                       = "Money",
    [SVar_GAME_TURN]                   = "Turn",
    [SVar_TOTAL_DIGGERS]               = "Tot Diggers",
    [SVar_TOTAL_CREATURES]             = "Tot Crt",
    [SVar_TOTAL_RESEARCH]              = "Tot Research",
    [SVar_TOTAL_DOORS]                 = "Tot Doors",
    [SVar_TOTAL_AREA]                  = "Tot Area",
    [SVar_TOTAL_CREATURES_LEFT]        = "Crt Left",
    [SVar_CREATURES_ANNOYED]           = "Crt Annoyed",
    [SVar_BATTLES_LOST]                = "Battles Lost",
    [SVar_BATTLES_WON]                 = "Battles Won",
    [SVar_ROOMS_DESTROYED]             = "Rooms Dest",
    [SVar_SPELLS_STOLEN]               = "Spells Stolen",
    [SVar_TIMES_BROKEN_INTO]           = "Intrusions",
    [SVar_TOTAL_GOLD_MINED]            = "Gold Mined",
    [SVar_FLAG]                        = "Flag",
    [SVar_ROOM_SLABS]                  = NULL,
    [SVar_DOORS_DESTROYED]             = "Doors Dest",
    [SVar_CREATURES_SCAVENGED_LOST]    = "Scav Lost",
    [SVar_CREATURES_SCAVENGED_GAINED]  = "Scav Gain",
    [SVar_AVAILABLE_MAGIC]             = "Magic Avail",
    [SVar_AVAILABLE_TRAP]              = NULL,
    [SVar_AVAILABLE_DOOR]              = NULL,
    [SVar_AVAILABLE_ROOM]              = NULL,
    [SVar_AVAILABLE_CREATURE]          = NULL,
    [SVar_CONTROLS_CREATURE]           = NULL,
    [SVar_CONTROLS_TOTAL_CREATURES]    = "Ctrl Crt Tot",
    [SVar_CONTROLS_TOTAL_DIGGERS]      = "Ctrl Diggers Tot",
    [SVar_ALL_DUNGEONS_DESTROYED]      = "All Dungeons Dest",
    [SVar_DOOR_NUM]                    = NULL,
    [SVar_TRAP_NUM]                    = NULL,
    [SVar_GOOD_CREATURES]              = "Good Crt",
    [SVar_EVIL_CREATURES]              = "Evil Crt",
    [SVar_CONTROLS_GOOD_CREATURES]     = "Ctrl Good",
    [SVar_CONTROLS_EVIL_CREATURES]     = "Ctrl Evil",
    [SVar_CAMPAIGN_FLAG]               = "Cmpgn Flag",
    [SVar_SLAB_OWNER]                  = "Slab Owner",
    [SVar_SLAB_TYPE]                   = "Slab Type",
    [SVar_HEART_HEALTH]                = "Heart Health",
    [SVar_GHOSTS_RAISED]               = "Ghosts Raised",
    [SVar_SKELETONS_RAISED]            = "Skel Raised",
    [SVar_VAMPIRES_RAISED]             = "Vamp Raised",
    [SVar_CREATURES_CONVERTED]         = "Crt Conv",
    [SVar_TIMES_ANNOYED_CREATURE]      = "Times Annoyed",
    [SVar_TIMES_TORTURED_CREATURE]     = "Tortured Count",
    [SVar_TOTAL_DOORS_MANUFACTURED]    = "Doors Manu",
    [SVar_TOTAL_TRAPS_MANUFACTURED]    = "Traps Manu",
    [SVar_TOTAL_MANUFACTURED]          = "Tot Manu",
    [SVar_TOTAL_TRAPS_USED]            = "Traps Used",
    [SVar_TOTAL_DOORS_USED]            = "Doors Used",
    [SVar_KEEPERS_DESTROYED]           = "Keepers Dest",
    [SVar_DESTROYED_KEEPER]            = "Keeper Dest",
    [SVar_CREATURES_SACRIFICED]        = "Sacr",
    [SVar_CREATURES_FROM_SACRIFICE]    = "From Sacr",
    [SVar_TIMES_LEVELUP_CREATURE]      = "Lvlup Count",
    [SVar_TOTAL_SALARY]                = "Tot Salary",
    [SVar_CURRENT_SALARY]              = "Curr Salary",
    [SVar_GOLD_POTS_STOLEN]            = "Gold Stolen",
    [SVar_TIMER]                       = "Timer",
    [SVar_DUNGEON_DESTROYED]           = "Dungeon Dest",
    [SVar_AVAILABLE_TOTAL_TRAPS]       = "Traps Avail",
    [SVar_AVAILABLE_TOTAL_DOORS]       = "Doors Avail",
    [SVar_AVAILABLE_TOTAL_CREATURES]   = "Crt Avail",
    [SVar_BOX_ACTIVATED]               = "Box Actived",
    [SVar_TRAP_ACTIVATED]              = "Trap Actived",
    [SVar_SACRIFICED]                  = "Sacr",
    [SVar_REWARDED]                    = "Rewarded",
    [SVar_EVIL_CREATURES_CONVERTED]    = "Evil Conv",
    [SVar_GOOD_CREATURES_CONVERTED]    = "Good Conv",
    [SVar_TRAPS_SOLD]                  = "Traps Sold",
    [SVar_DOORS_SOLD]                  = "Doors Sold",
    [SVar_MANUFACTURED_SOLD]           = "Manu Sold",
    [SVar_MANUFACTURE_GOLD]            = "Manu Gold",
    [SVar_TOTAL_SCORE]                 = "Total Score",
    [SVar_BONUS_TIME]                  = "Bonus Time",
    [SVar_CREATURES_TRANSFERRED]        = "Transferred",
    [SVar_ALLIED_PLAYER]               = "Allied Player",
    [SVar_ACTIVE_BATTLES]              = "Active Battles",
    [SVar_VIEW_TYPE]                   = "View Type",
    [SVar_TOTAL_SLAPS]                 = "Tot Slaps",
    [SVar_SCORE]                       = "Score",
    [SVar_PLAYER_SCORE]                = "Plyr Score",
    [SVar_MANAGE_SCORE]               = "Manage Score",
    [SVar_CONTROLLED_THING]            = "Cntrled",
};
...
//    init_creature_model_stats(i);
    game.conf.crtr_conf.model[i] = game.conf.crtr_conf.model[source_id];
    snprintf(game.conf.crtr_conf.model[i].name, COMMAND_WORD_LEN, "%s", name);
    creature_desc[i - 1].name = game.conf.crtr_conf.model[i].name;
    creature_desc[i - 1].num = i;
    for (int k = 0; k < CREATURE_GRAPHICS_INSTANCES; k++)
    {
        game.conf.crtr_conf.creature_graphics[i][k] = game.conf.crtr_conf.creature_graphics[source_id][k];
    }
    game.conf.crtr_conf.creature_sounds[i] = game.conf.crtr_conf.creature_sounds[source_id];
