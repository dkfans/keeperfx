...
const struct CommandDesc command_desc[] = {
  ...
  {"DISPLAY_OBJECTIVE",                 "Nlan      ", Cmd_DISPLAY_OBJECTIVE, &display_objective_check, &display_objective_process},
  {"DISPLAY_OBJECTIVE_WITH_POS",        "NNNan     ", Cmd_DISPLAY_OBJECTIVE_WITH_POS, &display_objective_check, &display_objective_process},
  {"DISPLAY_INFORMATION",               "Nla      ", Cmd_DISPLAY_INFORMATION, NULL, NULL},
  {"DISPLAY_INFORMATION_WITH_POS",      "NNNa     ", Cmd_DISPLAY_INFORMATION_WITH_POS, NULL, NULL},
  ...
  {"QUICK_OBJECTIVE",                   "NAla     ", Cmd_QUICK_OBJECTIVE, NULL, NULL},
  {"QUICK_INFORMATION",                 "NAla     ", Cmd_QUICK_INFORMATION, NULL, NULL},
  {"QUICK_OBJECTIVE_WITH_POS",          "NANNa    ", Cmd_QUICK_OBJECTIVE_WITH_POS, NULL, NULL},
  {"QUICK_INFORMATION_WITH_POS",        "NANNa    ", Cmd_QUICK_INFORMATION_WITH_POS, NULL, NULL},
