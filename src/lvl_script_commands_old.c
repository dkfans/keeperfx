...
const struct NamedCommand game_rule_desc[] = {
  ...
  {"PayDaySpeed",                   19},
  {"PayDayProgress",                20},
  {"DiseaseHPTemplePercentage",     21},
  {"DungeonHeartHealth",            22},
  {"HungerHealthLoss",              23},
  {"GameTurnsPerHungerHealthLoss",  24},
  {"FoodHealthGain",                25},
  {"TortureHealthLoss",             26},
  {"GameTurnsPerTortureHealthLoss", 27},
  {"AlliesShareVision",             28},
  {"AlliesShareDrop",               29},
  {"AlliesShareCta",                30},
  {"BarrackMaxPartySize",           31},
  {"MaxThingsInHand",               32},
  {NULL,                             0},
};
