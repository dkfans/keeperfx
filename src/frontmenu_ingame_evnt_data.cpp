...
struct GuiButtonInit text_info_buttons[] = {
  ...
  { 1, 66, 0, 0, gui_scroll_text_up, NULL,        NULL,               0, 446,   4, 446,   4, 30, 24, gui_area_new_normal_button,      486, GUIStr_Empty,  0,{(long)&game.evntbox_scroll_window},0,maintain_scroll_up },
  { 1, 65, 0, 0, gui_scroll_text_down,NULL,       NULL,               0, 446,  56, 446,  56, 30, 24, gui_area_new_normal_button,      272, GUIStr_Empty,  0,{(long)&game.evntbox_scroll_window},0,maintain_scroll_down },
...
struct GuiButtonInit battle_buttons[] = {
  ...
  { 1,  0, 0, 0, gui_previous_battle,NULL,        NULL,               0, 446,   4, 446,   4, 30, 24, gui_area_new_normal_button,      486, GUIStr_NextBattleDesc,0,      {0},            0, NULL },
  { 1,  0, 0, 0, gui_next_battle,NULL,            NULL,               0, 446,  72, 446,  72, 30, 24, gui_area_new_normal_button,      272, GUIStr_NextBattleDesc,0,      {0},            0, NULL },
