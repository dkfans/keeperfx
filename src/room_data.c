...
unsigned short const room_effect_elements[] = { TngEffElm_RedFlame, TngEffElm_BlueFlame, TngEffElm_GreenFlame, TngEffElm_YellowFlame, TngEffElm_YellowFlame, TngEffElm_None };
/******************************************************************************/
#ifdef __cplusplus
}
#endif
