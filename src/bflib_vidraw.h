...
#define SPRITE_SCALING_XSTEPS ((MAX_SUPPORTED_SPRITE_DIM) > (MAX_SUPPORTED_SCREEN_WIDTH) ? (MAX_SUPPORTED_SPRITE_DIM) : (MAX_SUPPORTED_SCREEN_WIDTH))
#define SPRITE_SCALING_YSTEPS ((MAX_SUPPORTED_SPRITE_DIM) > (MAX_SUPPORTED_SCREEN_HEIGHT) ? (MAX_SUPPORTED_SPRITE_DIM) : (MAX_SUPPORTED_SCREEN_HEIGHT))
/******************************************************************************/
#pragma pack(1)
