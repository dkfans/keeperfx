...
CrAttackType creature_can_have_combat_with_creature(struct Thing *fighter1, struct Thing *fighter2, int32_t dist, int32_t move_on_ground, int32_t set_if_seen);
CrAttackType creature_can_have_combat_with_object(struct Thing* fighter1, struct Thing* fighter2, int32_t dist, int32_t move_on_ground, int32_t set_if_seen);
...
int32_t get_combat_distance(const struct Thing *thing, const struct Thing *enemy);
...
int32_t remove_all_traces_of_combat(struct Thing *thing);
