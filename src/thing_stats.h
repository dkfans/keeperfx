...
GoldAmount compute_creature_max_pay(GoldAmount base_pay, CrtrExpLevel crlevel);
GoldAmount compute_creature_max_training_cost(GoldAmount base_training_cost, CrtrExpLevel crlevel);
GoldAmount compute_creature_max_scavenging_cost(GoldAmount base_scavenging_cost, CrtrExpLevel crlevel);
