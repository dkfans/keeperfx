...
enum ThingEffectElements {
    ...
    TngEffElm_UnusedSlot31,
    TngEffElm_LavaFlameMoving,
    TngEffElm_LargeRock2,
    TngEffElm_UnusedSlot34,
    TngEffElm_UnusedSlot35,
    TngEffElm_UnusedSlot36,
