...
char *load_letter_one_file(char letter, unsigned long tmapidx, unsigned char *dst)
{
    SYNCDBG(9,"Starting");
    
    const char* fname = prepare_file_fmtpath_prio(FGrp_StdData, FGrp_CmpgConfig, true, "tmap%c%03d.dat", letter, tmapidx);
