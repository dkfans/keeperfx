...
static const struct NamedField magic_powers_named_fields[] = {
    ...
    {"NAME",           0, field(game.conf.magic_conf.power_cfgstats[0].code_name),              0, LONG_MIN,UINT32_MAX, power_desc,                          value_name,      assign_null},
    {"POWER",          0, field(game.conf.magic_conf.power_cfgstats[0].strength[0]),            0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"POWER",          1, field(game.conf.magic_conf.power_cfgstats[0].strength[1]),            0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"POWER",          2, field(game.conf.magic_conf.power_cfgstats[0].strength[2]),            0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"POWER",          3, field(game.conf.magic_conf.power_cfgstats[0].strength[3]),            0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"POWER",          4, field(game.conf.magic_conf.power_cfgstats[0].strength[4]),            0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"POWER",          5, field(game.conf.magic_conf.power_cfgstats[0].strength[5]),            0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"POWER",          6, field(game.conf.magic_conf.power_cfgstats[0].strength[6]),            0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"POWER",          7, field(game.conf.magic_conf.power_cfgstats[0].strength[7]),            0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"POWER",          8, field(game.conf.magic_conf.power_cfgstats[0].strength[8]),            0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_strength_before_last},
    {"POWER",          8, field(game.conf.magic_conf.power_cfgstats[0].strength[9]),            0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"COST",           0, field(game.conf.magic_conf.power_cfgstats[0].cost[0]),                0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"COST",           1, field(game.conf.magic_conf.power_cfgstats[0].cost[1]),                0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"COST",           2, field(game.conf.magic_conf.power_cfgstats[0].cost[2]),                0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"COST",           3, field(game.conf.magic_conf.power_cfgstats[0].cost[3]),                0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"COST",           4, field(game.conf.magic_conf.power_cfgstats[0].cost[4]),                0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"COST",           5, field(game.conf.magic_conf.power_cfgstats[0].cost[5]),                0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"COST",           6, field(game.conf.magic_conf.power_cfgstats[0].cost[6]),                0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"COST",           7, field(game.conf.magic_conf.power_cfgstats[0].cost[7]),                0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"COST",           7, field(game.conf.magic_conf.power_cfgstats[0].cost[8]),                0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"DURATION",       0, field(game.conf.magic_conf.power_cfgstats[0].duration),               0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"CASTABILITY",   -1, field(game.conf.magic_conf.power_cfgstats[0].can_cast_flags),         0, LONG_MIN,UINT32_MAX, (struct NamedCommand*)powermodel_castability_commands, value_longflagsfield,   assign_default},
    {"ARTIFACT",       0, field(game.conf.magic_conf.power_cfgstats[0].artifact_model),         0, LONG_MIN,UINT32_MAX, object_desc,                         value_default,   assign_artifact},
    {"NAMETEXTID",     0, field(game.conf.magic_conf.power_cfgstats[0].name_stridx),            0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"TOOLTIPTEXTID",  0, field(game.conf.magic_conf.power_cfgstats[0].tooltip_stridx),         0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"SYMBOLSPRITES",  0, field(game.conf.magic_conf.power_cfgstats[0].bigsym_sprite_idx),      0, LONG_MIN,UINT32_MAX, NULL,                                value_icon,      assign_icon},
    {"SYMBOLSPRITES",  1, field(game.conf.magic_conf.power_cfgstats[0].medsym_sprite_idx),      0, LONG_MIN,UINT32_MAX, NULL,                                value_icon,      assign_icon},
    {"POINTERSPRITES", 0, field(game.conf.magic_conf.power_cfgstats[0].pointer_sprite_idx),     0, LONG_MIN,UINT32_MAX, NULL,                                value_icon,      assign_icon},
    {"PANELTABINDEX",  0, field(game.conf.magic_conf.power_cfgstats[0].panel_tab_idx),          0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"SOUNDSAMPLES",   0, field(game.conf.magic_conf.power_cfgstats[0].select_sample_idx),      0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"PROPERTIES",     0, field(game.conf.magic_conf.power_cfgstats[0].config_flags),           0, LONG_MIN,UINT32_MAX, powermodel_properties_commands,      value_flagsfield,assign_default},
    {"CASTEXPANDFUNC", 0, field(game.conf.magic_conf.power_cfgstats[0].overcharge_check_idx),   0, LONG_MIN,UINT32_MAX, powermodel_expand_check_func_type,   value_default,   assign_default},
    {"PLAYERSTATE",    0, field(game.conf.magic_conf.power_cfgstats[0].work_state),             0, LONG_MIN,UINT32_MAX, player_state_commands,               value_default,   assign_default},
    {"PARENTPOWER",    0, field(game.conf.magic_conf.power_cfgstats[0].parent_power),           0, LONG_MIN,UINT32_MAX, power_desc,                          value_default,   assign_default},
    {"SOUNDPLAYED",    0, field(game.conf.magic_conf.power_cfgstats[0].select_sound_idx),       0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"COOLDOWN",       0, field(game.conf.magic_conf.power_cfgstats[0].cast_cooldown),          0, LONG_MIN,UINT32_MAX, NULL,                                value_default,   assign_default},
    {"SPELL",          0, field(game.conf.magic_conf.power_cfgstats[0].spell_idx),              0, LONG_MIN,UINT32_MAX, spell_desc,                          value_default,   assign_default},
    {"EFFECT",         0, field(game.conf.magic_conf.power_cfgstats[0].effect_id),              0, LONG_MIN,UINT32_MAX, NULL,                                value_effOrEffEl,assign_default},
    {"USEFUNCTION",    0, field(game.conf.magic_conf.power_cfgstats[0].magic_use_func_idx),     0, LONG_MIN,UINT32_MAX, magic_use_func_commands,             value_function,  assign_default},
    {"CREATURETYPE",   0, field(game.conf.magic_conf.power_cfgstats[0].creature_model),         0, LONG_MIN,UINT32_MAX, creature_desc,                       value_default,   assign_default},
    {"COSTFORMULA",    0, field(game.conf.magic_conf.power_cfgstats[0].cost_formula),           0, LONG_MIN,UINT32_MAX, magic_cost_formula_commands,         value_default,   assign_default},
    {NULL},
};
