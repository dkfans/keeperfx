...
void script_process_value(unsigned long var_index, unsigned long plr_range_id, long val2, long val3, long val4, struct ScriptValue *value)
{
  ...
  case Cmd_SET_INCREASE_ON_EXPERIENCE:
      ...
      case 1: //SizeIncreaseOnExp
          if ((val3 >= 0) && (val3 <= SHRT_MAX))
          {
              SCRIPTDBG(7,"Changing variable %d from %d to %d", val2, game.conf.crtr_conf.exp.size_increase_on_exp, val3);
              game.conf.crtr_conf.exp.size_increase_on_exp = val3;
          }
          else
          {
              SCRPTERRLOG("Variable '%d' value %d out of range", val2, val3);
          }
          break;
      case 2: //PayIncreaseOnExp
          if ((val3 >= 0) && (val3 <= SHRT_MAX))
          {
              SCRIPTDBG(7,"Changing variable %d from %d to %d", val2, game.conf.crtr_conf.exp.pay_increase_on_exp, val3);
              game.conf.crtr_conf.exp.pay_increase_on_exp = val3;
          }
          else
          {
              SCRPTERRLOG("Variable '%d' value %d out of range", val2, val3);
      ...
      case 3: //SpellDamageIncreaseOnExp
          if ((val3 >= 0) && (val3 <= SHRT_MAX))
          {
              SCRIPTDBG(7,"Changing variable %d from %d to %d", val2, game.conf.crtr_conf.exp.spell_damage_increase_on_exp, val3);
              game.conf.crtr_conf.exp.spell_damage_increase_on_exp = val3;
          }
          else
          {
              SCRPTERRLOG("Variable '%d' value %d out of range", val2, val3);
      ...
      case 4: //RangeIncreaseOnExp
          if ((val3 >= 0) && (val3 <= SHRT_MAX))
          {
              SCRIPTDBG(7,"Changing variable %d from %d to %d", val2, game.conf.crtr_conf.exp.range_increase_on_exp, val3);
              game.conf.crtr_conf.exp.range_increase_on_exp = val3;
          }
          else
          {
              SCRPTERRLOG("Variable '%d' value %d out of range", val2, val3);
      ...
      case 5: //JobValueIncreaseOnExp
          if ((val3 >= 0) && (val3 <= SHRT_MAX))
          {
              SCRIPTDBG(7,"Changing variable %d from %d to %d", val2, game.conf.crtr_conf.exp.job_value_increase_on_exp, val3);
              game.conf.crtr_conf.exp.job_value_increase_on_exp = val3;
          }
          else
          {
              SCRPTERRLOG("Variable '%d' value %d out of range", val2, val3);
      ...
      case 6: //HealthIncreaseOnExp
          if ((val3 >= 0) && (val3 <= SHRT_MAX))
          {
              SCRIPTDBG(7,"Changing variable %d from %d to %d", val2, game.conf.crtr_conf.exp.health_increase_on_exp, val3);
              game.conf.crtr_conf.exp.health_increase_on_exp = val3;
          }
          else
          {
              SCRPTERRLOG("Variable '%d' value %d out of range", val2, val3);
      ...
      case 7: //StrengthIncreaseOnExp
          if ((val3 >= 0) && (val3 <= SHRT_MAX))
          {
              SCRIPTDBG(7,"Changing variable %d from %d to %d", val2, game.conf.crtr_conf.exp.strength_increase_on_exp, val3);
              game.conf.crtr_conf.exp.strength_increase_on_exp = val3;
          }
          else
          {
              SCRPTERRLOG("Variable '%d' value %d out of range", val2, val3);
      ...
      case 8: //DexterityIncreaseOnExp
          if ((val3 >= 0) && (val3 <= SHRT_MAX))
          {
              SCRIPTDBG(7,"Changing variable %d from %d to %d", val2, game.conf.crtr_conf.exp.dexterity_increase_on_exp, val3);
              game.conf.crtr_conf.exp.dexterity_increase_on_exp = val3;
          }
          else
          {
              SCRPTERRLOG("Variable '%d' value %d out of range", val2, val3);
      ...
      case 9: //DefenseIncreaseOnExp
          if ((val3 >= 0) && (val3 <= SHRT_MAX))
          {
              SCRIPTDBG(7,"Changing variable %d from %d to %d", val2, game.conf.crtr_conf.exp.defense_increase_on_exp, val3);
              game.conf.crtr_conf.exp.defense_increase_on_exp = val3;
          }
          else
          {
              SCRPTERRLOG("Variable '%d' value %d out of range", val2, val3);
      ...
      case 10: //LoyaltyIncreaseOnExp
          if ((val3 >= 0) && (val3 <= SHRT_MAX))
          {
              SCRIPTDBG(7,"Changing variable %d from %d to %d", val2, game.conf.crtr_conf.exp.loyalty_increase_on_exp, val3);
              game.conf.crtr_conf.exp.loyalty_increase_on_exp = val3;
          }
          else
          {
              SCRPTERRLOG("Variable '%d' value %d out of range", val2, val3);
      ...
      case 11: //ExpForHittingIncreaseOnExp
          if ((val3 >= 0) && (val3 <= SHRT_MAX))
          {
              SCRIPTDBG(7,"Changing variable %d from %d to %d", val2, game.conf.crtr_conf.exp.exp_on_hitting_increase_on_exp, val3);
              game.conf.crtr_conf.exp.exp_on_hitting_increase_on_exp = val3;
          }
          else
          {
              SCRPTERRLOG("Variable '%d' value %d out of range", val2, val3);
          ...
          break;
      default:
          WARNMSG("Unsupported variable, command %d.", val2);
          break;
      }
      break;
  default:
