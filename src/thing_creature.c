...
void set_creature_level(struct Thing *thing, long nlvl)
{
    ...
    thing->solid_size_xy = crstat->thing_size_xy; // Used for navigation, growing it would stop them from fitting. No pathfinding support yet.
    thing->solid_size_yz = crstat->thing_size_yz;
}
