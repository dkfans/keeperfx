...
const struct NamedField magic_shot_named_fields[] = {
  ...
  {"PROPERTIES",            0, field(game.conf.magic_conf.shot_cfgstats[0].model_flags),               0,  INT32_MIN,  UINT32_MAX, shotmodel_properties_commands,value_flagsfield,assign_withstand},
  ...
  {"SPELLEFFECT",           0, field(game.conf.magic_conf.shot_cfgstats[0].spell_effect),              0,  INT32_MIN,  UINT32_MAX, spell_desc,                   value_default,   assign_default},
  ...
  {"SIZE_YZ",               0, field(game.conf.magic_conf.shot_cfgstats[0].size_yz),                   0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  ...
  {"VISUALEFFECT",          0, field(game.conf.magic_conf.shot_cfgstats[0].visual_effect),             0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"VISUALEFFECTAMOUNT",    0, field(game.conf.magic_conf.shot_cfgstats[0].visual_effect_amount),      0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"VISUALEFFECTSPREAD",    0, field(game.conf.magic_conf.shot_cfgstats[0].visual_effect_spread),      0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"VISUALEFFECTHEALTH",    0, field(game.conf.magic_conf.shot_cfgstats[0].visual_effect_health),      0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"HITWALLEFFECT",         0, field(game.conf.magic_conf.shot_cfgstats[0].hit_wall_effect),           0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"HITWALLSOUND",          0, field(game.conf.magic_conf.shot_cfgstats[0].hit_wall_sound),            0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"HITCREATUREEFFECT",     0, field(game.conf.magic_conf.shot_cfgstats[0].hit_creature_effect),       0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"HITCREATURESOUND",      0, field(game.conf.magic_conf.shot_cfgstats[0].hit_creature_sound),        0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"HITDOOREFFECT",         0, field(game.conf.magic_conf.shot_cfgstats[0].hit_door_effect),           0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"HITDOORSOUND",          0, field(game.conf.magic_conf.shot_cfgstats[0].hit_door_sound),            0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"HITWATEREFFECT",        0, field(game.conf.magic_conf.shot_cfgstats[0].hit_water_effect),          0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"HITWATERSOUND",         0, field(game.conf.magic_conf.shot_cfgstats[0].hit_water_sound),           0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"HITLAVAEFFECT",         0, field(game.conf.magic_conf.shot_cfgstats[0].hit_lava_effect),           0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"HITLAVASOUND",          0, field(game.conf.magic_conf.shot_cfgstats[0].hit_lava_sound),            0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"DIGHITEFFECT",          0, field(game.conf.magic_conf.shot_cfgstats[0].dig_hit_effect),            0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"DIGHITSOUND",           0, field(game.conf.magic_conf.shot_cfgstats[0].dig_hit_sound),             0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"EXPLOSIONEFFECTS",      0, field(game.conf.magic_conf.shot_cfgstats[0].explosion_effects),         0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"EXPLOSIONEFFECTS",      1, field(game.conf.magic_conf.shot_cfgstats[0].explosion_effects),         0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"EXPLOSIONEFFECTS",      2, field(game.conf.magic_conf.shot_cfgstats[0].explosion_effects),         0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"EXPLOSIONEFFECTS",      3, field(game.conf.magic_conf.shot_cfgstats[0].explosion_effects),         0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"WITHSTANDHITAGAINST",   0, NULL,0                                                                  0,  INT32_MIN,  UINT32_MAX, shotmodel_withstand_types,    value_flagsfield,   assign_default},
  ...
  {"DESTROYONHIT",          0, field(game.conf.magic_conf.shot_cfgstats[0].destroy_on_hit),            0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"BASEEXPERIENCEGAIN",    0, field(game.conf.magic_conf.shot_cfgstats[0].base_experience_gain),      0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"TARGETHITSTOPTURNS",    0, field(game.conf.magic_conf.shot_cfgstats[0].target_hit_stop_turns),     0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"SHOTSOUNDPRIORITY",     0, field(game.conf.magic_conf.shot_cfgstats[0].shot_sound_priority),       0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  ...
  {"EFFECTMODEL",           0, field(game.conf.magic_conf.shot_cfgstats[0].effect_model),              0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  ...
  {"HITHEARTEFFECT",        0, field(game.conf.magic_conf.shot_cfgstats[0].hit_heart_effect),          0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"HITHEARTSOUND",         0, field(game.conf.magic_conf.shot_cfgstats[0].hit_heart_sound),           0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"BLEEDINGEFFECT",        0, field(game.conf.magic_conf.shot_cfgstats[0].bleeding_effect),           0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"FROZENEFFECT",          0, field(game.conf.magic_conf.shot_cfgstats[0].frozen_effect),             0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
