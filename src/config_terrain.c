...
static const struct NamedCommand terrain_room_properties_commands[] = {
    ...
    {"DESTROYED_BY_BOULDER",       RoCFlg_BoulderDestroys},
    {NULL,                0},
};
...
static const struct NamedField terrain_slab_named_fields[] = {
    ...
    {"TOOLTIPTEXTID",     0, field_t(struct SlabConfigStats, tooltip_stridx),     GUIStr_Empty, INT32_MIN,UINT32_MAX, NULL,          value_stringId,    assign_default},
...
static const struct NamedField terrain_room_named_fields[] = {
    ...
    {"NAMETEXTID",        0, field_t(struct RoomConfigStats, name_stridx),        GUIStr_Empty, INT32_MIN,UINT32_MAX,      NULL,                                 value_stringId,   assign_default},
    {"TOOLTIPTEXTID",     0, field_t(struct RoomConfigStats, tooltip_stridx),     GUIStr_Empty, INT32_MIN,UINT32_MAX,      NULL,                                 value_stringId,   assign_update_room_tab},
    ...
    {"TOTALCAPACITY",     0, field_t(struct RoomConfigStats, update_total_capacity_idx),     0, INT32_MIN,UINT32_MAX,      terrain_room_total_capacity_func_type,value_function,    assign_reinitialise_rooms},
    {"USEDCAPACITY",      0, field_t(struct RoomConfigStats, update_storage_in_room_idx),    0, INT32_MIN,UINT32_MAX,      terrain_room_used_capacity_func_type, value_function,    assign_default},
    {"USEDCAPACITY",      1, field_t(struct RoomConfigStats, update_workers_in_room_idx),    0, INT32_MIN,UINT32_MAX,      terrain_room_used_capacity_func_type, value_function,    assign_reinitialise_rooms},
