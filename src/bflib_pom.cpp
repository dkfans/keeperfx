...
void PhaseOfMoon::FlMoon(const long n, const short nph, long &jd, double &frac)
{
    ...
    if ((nph == 0) || (nph == 2))
    {
        ...
        xtra += (0.1734 - 3.93e-4 * t) * sin(RAD * as) + 0.0021 * sin(2.0 * RAD * as) - 0.4068 * sin(RAD * am) + 0.0161 * sin(2 * RAD * am) - 0.0004 * sin(3 * RAD * am) + 0.0104 * sin(2 * RAD * fml) - 0.0051 * sin(RAD * (as + am)) - 0.0074 * sin(RAD * (as - am)) + 0.0004 * sin(RAD * (2 * fml + as)) - 0.0004 * sin(RAD * (2 * fml - as)) - 0.0006 * sin(RAD * (2 * fml + am)) + 0.0010 * sin(RAD * (2 * fml - am)) + 0.0005 * sin(RAD * (as + 2 * am));
    }
    else if ((nph == 1) || (nph == 3))
    {
        xtra += (0.1721 - 4.0e-4 * t) * sin(RAD * as) + 0.0021 * sin(2 * RAD * as) - 0.6280 * sin(RAD * am) + 0.0089 * sin(2 * RAD * am) - 0.0004 * sin(3 * RAD * am) + 0.0079 * sin(2 * RAD * fml) - 0.0119 * sin(RAD * (as + am)) - 0.0047 * sin(RAD * (as - am)) + 0.0003 * sin(RAD * (2 * fml + as)) - 0.0004 * sin(RAD * (2 * fml - as)) - 0.0006 * sin(RAD * (2 * fml + am)) + 0.0021 * sin(RAD * (2 * fml - am)) + 0.0003 * sin(RAD * (as + 2 * am)) + 0.0004 * sin(RAD * (as - 2 * am)) - 0.0003 * sin(RAD * (2 * as + am));
    }
    else
    {
...
long PhaseOfMoon::JulDay(const short mm, const short id, const int iyyy)
{
    ...
    if (jy == 0)
    {
        pom_error("JulDay: there is no year zero.");
    }
    if (jy < 0)
    {
        ++jy;
