...
const struct NamedField trapdoor_trap_named_fields[] = {
    ...
    {"SHOTORIGIN",             0, field(game.conf.trapdoor_conf.trap_cfgstats[0].shot_shift_x),                     0,          0,         ULONG_MAX, NULL,                     value_default, assign_default},
    {"SHOTORIGIN",             1, field(game.conf.trapdoor_conf.trap_cfgstats[0].shot_shift_y),                     0,          0,         ULONG_MAX, NULL,                     value_default, assign_default},
    {"SHOTORIGIN",             2, field(game.conf.trapdoor_conf.trap_cfgstats[0].shot_shift_z),                     0,          0,         ULONG_MAX, NULL,                     value_default, assign_default},
