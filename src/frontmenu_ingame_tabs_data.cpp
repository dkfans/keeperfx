...
struct GuiButtonInit creature_query_buttons1[] = {
  ...
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, gui_query_next_creature_of_owner,    gui_query_next_creature_of_owner_and_model,         NULL,               0,   4, 262,   4, 262,126, 14, NULL,                              0, GUIStr_NameAndHealthDesc,0,       {0},               0, NULL },
...
struct GuiButtonInit creature_query_buttons3[] = {
  ...
  {LbBtnT_NormalBtn,    BID_DEFAULT,    0, 0, gui_query_next_creature_of_owner,    gui_query_next_creature_of_owner_and_model,         NULL,               0,   4, 200,   4, 200,126, 14, NULL,                              0, GUIStr_NameAndHealthDesc,0,       {0},               0, NULL },
...
struct GuiButtonInit creature_query_buttons4[] = {
  {LbBtnT_NormalBtn,    BID_DEFAULT,    0, 1, NULL,                                NULL,                                               NULL,               0,  44, 374,  44, 374, 52, 20, gui_area_new_normal_button, GPS_rpanel_rpanel_btn_nxpage_act, GUIStr_MoreInformation,&creature_query_menu1,           {0}, 0, NULL },
   {LbBtnT_NormalBtn,    ID_DEFAULT,    0, 0, gui_query_next_creature_of_owner,    gui_query_next_creature_of_owner_and_model,         NULL,               0,   4, 200,   4, 200,126, 14, NULL,                              0, GUIStr_NameAndHealthDesc,0,       {0},               0, NULL },
