...
enum IngameButtonDesignationIDs {
    ...
    BID_MAP_MENU,
    BID_MAP_GOLD,
    BID_MSG_EV04_OLD_UNUSED,
    BID_MSG_EV05_OLD_UNUSED,
    BID_MSG_EV06_OLD_UNUSED,//45
    BID_MSG_EV07_OLD_UNUSED,
    BID_MSG_EV08_OLD_UNUSED,
    BID_MSG_EV09_OLD_UNUSED,
    BID_MSG_EV10_OLD_UNUSED,
    BID_MSG_EV11_OLD_UNUSED,//50
    BID_MSG_EV12_OLD_UNUSED,
    BID_MSG_EV13_OLD_UNUSED,
    BID_MNFCT_TD01,
    BID_MNFCT_TD02,
    BID_MNFCT_TD03,//55
    BID_MNFCT_TD04,
