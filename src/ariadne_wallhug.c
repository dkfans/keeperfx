...
static int hug_round(struct Thing *creatng, struct Coord3d *pos1, struct Coord3d *pos2, unsigned short round_idx, long *hug_val)
{
    ...
    MapSubtlDelta dist_1 = manhattan_distance(pos1_stl_x, pos1_stl_y, pos2_stl_x, pos2_stl_y);
    MapSubtlDelta dist_2 = manhattan_distance(pos1_stl_x_2, pos1_stl_y_2, pos2_stl_x, pos2_stl_y);
    if (dist_2 >= dist_1)
    {
      pos1->x.stl.num = pos1_stl_x;
      pos1->y.stl.num = pos1_stl_y;
