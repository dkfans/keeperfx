...
void light_turn_light_off(int32_t num);
void light_turn_light_on(int32_t num);
...
void light_init_dungeon_heart(int32_t lgt_id, int32_t radius, int32_t intensity);
