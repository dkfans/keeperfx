...
#endif
/******************************************************************************/
DKINTERN Offset _DK_vert_offset[3];
DKINTERN Offset _DK_hori_offset[3];
DKINTERN Offset _DK_high_offset[3];
DKINTERN long _DK_x_init_off;
DKINTERN long _DK_y_init_off;
DKINTERN long _DK_floor_pointed_at_x;
DKINTERN long _DK_floor_pointed_at_y;
DKINTERN long _DK_fade_max;
DKINTERN long _DK_fade_scaler;
DKINTERN long _DK_fade_way_out;
DKINTERN struct MapVolumeBox _DK_map_volume_box;
DKINTERN long _DK_map_roll;
DKINTERN long _DK_map_tilt;
DKINTERN long _DK_view_alt;
DKINTERN long _DK_fade_min;
DKINTERN long _DK_split_1;
DKINTERN long _DK_split_2;
DKINTERN long _DK_fade_range;
DKINTERN long _DK_depth_init_off;
DKINTERN int _DK_normal_shade_left;
DKINTERN int _DK_normal_shade_right;
DKINTERN long _DK_apos;
DKINTERN long _DK_bpos;
DKINTERN long _DK_ScrCenterX;
DKINTERN long _DK_ScrWidth;
DKINTERN long _DK_ScrHeight;
DKINTERN long _DK_ScrCenterY;
DKINTERN long _DK_split1at;
DKINTERN long _DK_split2at;
DKINTERN long _DK_view_height_over_2;
DKINTERN long _DK_view_width_over_2;
DKINTERN long _DK_map_x_pos;
DKINTERN long _DK_map_y_pos;
DKINTERN long _DK_map_z_pos;
DKINTERN int _DK_normal_shade_front;
DKINTERN int _DK_normal_shade_back;
DKINTERN unsigned char _DK_temp_cluedo_mode; // This is true(1) if the "short wall" have been enabled in the graphics options
DKINTERN long _DK_me_distance;
DKINTERN short _DK_mx;
DKINTERN short _DK_my;
DKINTERN short _DK_mz;
DKINTERN unsigned char _DK_engine_player_number;
DKINTERN unsigned char _DK_player_bit;
DKINTERN long _DK_UseFastBlockDraw;
DKINTERN unsigned char *_DK_gtblock_screen_addr;
DKINTERN long _DK_gtblock_clip_width;
DKINTERN long _DK_gtblock_clip_height;
DKINTERN long _DK_gtblock_screen_width;
DKINTERN long _DK_thelens;
DKINTERN long _DK_fade_mmm;
DKINTERN long _DK_spr_map_angle;
DKINTERN long _DK_lfade_max;
DKINTERN long _DK_lfade_min;
DKINTERN struct Thing *_DK_thing_being_displayed;
DKINTERN unsigned char _DK_thing_being_displayed_is_creature;
DKINTERN long _DK_global_scaler;
DKINTERN long _DK_water_source_cutoff;
DKINTERN long _DK_water_y_offset;
DKINTERN TbSpriteData *_DK_keepsprite[KEEPSPRITE_LENGTH];
DKINTERN struct HeapMgrHandle * _DK_heap_handle[KEEPSPRITE_LENGTH];
DKINTERN struct HeapMgrHeader *_DK_graphics_heap;
DKINTERN TbFileHandle _DK_file_handle;
DKINTERN long _DK_cam_map_angle;
/******************************************************************************/
