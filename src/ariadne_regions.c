...
TbBool regions_connected(long tree_reg1, long tree_reg2)
{
    ...
    if (Regions[reg_id1].allocated == 1)
        return (reg_id2 == reg_id1);
    if (Regions[reg_id2].allocated == 1)
        return (reg_id2 == reg_id1);
