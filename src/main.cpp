...
TngUpdateRet damage_creatures_with_physical_force(struct Thing *thing, ModTngFilterParam param)
{
    ...
    if (thing_is_creature(thing))
    {
        apply_damage_to_thing_and_display_health(thing, param->secondary_number, param->primary_number, INVALID_THING, DSK_PhysicalForce);
    ...
    {
        apply_damage_to_thing(thing, param->secondary_number, param->primary_number, INVALID_THING, DSK_PhysicalForce);
        return TUFRet_Modified;
    }
    return TUFRet_Unchanged;
}
