            ...
            if ((inst_inf->func_idx != 2) || (!creature_affected_by_spell(thing, inst_inf->func_params[0])))
            {
                if ( !(thing_is_creature_special_digger(thing) && creature_is_doing_digger_activity(thing)) || (flag_is_set(inst_inf->instance_property_flags, InstPF_DiggerTask)) )
                {
                    if ((!in_custody) || (flag_is_set(inst_inf->instance_property_flags, InstPF_WhileImprisoned)))
                    {
                        ...
                        {
                            if ((flag_is_set(inst_inf->instance_property_flags, InstPF_Waiting)) || (state_type != CrStTyp_Idle))
                            {
                                b = true;
                                INSTANCE_RET_IF_AVAIL(thing, i);
                            }
                        ...
                        else
                        {
                            ...
                            {
                                b = true;
                                if (flag_is_set(inst_inf->instance_property_flags, InstPF_OutOfBattle))
                                {
                                    INSTANCE_RET_IF_AVAIL(thing, i);
                                }
                            }
                        ...
                        {
                            b = true;
                            if (flag_is_set(inst_inf->instance_property_flags, InstPF_OnToxicTerrain))
                            {
                                INSTANCE_RET_IF_AVAIL(thing, i);
                            }
                        }
                        ...
                        {
                            b = true;
                            if (flag_is_set(inst_inf->instance_property_flags, InstPF_AgainstObject))
                            {
                                INSTANCE_RET_IF_AVAIL(thing, i);
                            }
                        }
                        ...
                        {
                            b = true;
                            if (flag_is_set(inst_inf->instance_property_flags, InstPF_AgainstDoor))
                            {
                                INSTANCE_RET_IF_AVAIL(thing, i);
                            }
                        }
