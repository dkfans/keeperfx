...
---@return Thing object
function AddObjectToLevel(object,location,property,player) local ob return ob end
...
---@param player? playersingle When used it sets the owner of the object.
---@return Thing object
function AddObjectToLevelAtPos(object,stl_x,stl_y,property,player) local ob return ob end