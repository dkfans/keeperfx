...
---@field state_besides_interruptions creature_state the state the creature is in, ignoring interruption states like being moving around or being slapped. Used for checking what the creature is actually doing instead of just what state it is in. read-only
