...
struct GuiButtonInit video_menu_buttons[] = {
  ...
  {LbBtnT_NormalBtn,  BID_DEFAULT, 0, 0, gui_switch_video_mode, gui_display_current_resolution, NULL,                   0,  104,  90,  106, 90, 46, 64, gui_area_no_anim_button,         122, GUIStr_DisplayResolution,0,{0}, 0, NULL },
  {              -1,  BID_DEFAULT, 0, 0, NULL,               NULL,        NULL,               0,   0,   0,   0,   0,  0,  0, NULL,                              0,   0,                     0,       {0},            0, NULL },
};
