...
/******************************************************************************/
#define CREATURE_OWNER_FLAG (1 << creatng->owner) // set creature owner flag in crt_owner_flags
#define CHECK_SLAB_OWNER (((1 << slabmap_owner(slb)) & crt_owner_flags) != 0) // return TRUE if the creature and slab are owned by the same player, unless...
#define IGNORE_SLAB_OWNER_CHECK 0 // if crt_owner_flags == 0, CHECK_SLAB_OWNER will always return false
/******************************************************************************/
#ifdef __cplusplus
}
#endif
