...
struct SpellData spell_data[] = {
  //PckA,                  PlayerState,       ?,  SymbolSprites1,   *2,  NameTextID,  TooltipTextID,  SoundSamples,  ?,  Functions,  Castability?
  ...
  {PckA_SetPlyrState,      PSt_Rebound,       0,             556,  412,  1053,  230,   0,   0, general_expand_check,         PwCast_Anywhere}, //[20] Rebound
