...
WARNFLAGS = -Wall -W -Wshadow -Wno-deprecated -Wno-deprecated-declarations -Wno-sign-compare -Wno-unused-parameter -Wno-strict-aliasing -Wno-unknown-pragmas -Werror
