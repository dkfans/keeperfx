...
// Temp fix for missing SDLK_LAST in SDL 2.0
// TODO HeM remove this and find better solution
#define SDLK_FIRST 0
TbKeyCode keymap_sdl_to_bf[SDL_SCANCODE_TO_KEYCODE(SDL_NUM_SCANCODES) - 0];
/******************************************************************************/
/**
...
void prepare_keys_mapping(void)
{
    ...
    keymap_sdl_to_bf[SDLK_KP_0 - SDLK_FIRST] = KC_NUMPAD0;
    keymap_sdl_to_bf[SDLK_KP_1 - SDLK_FIRST] = KC_NUMPAD1;
    keymap_sdl_to_bf[SDLK_KP_2 - SDLK_FIRST] = KC_NUMPAD2;
    keymap_sdl_to_bf[SDLK_KP_3 - SDLK_FIRST] = KC_NUMPAD3;
    keymap_sdl_to_bf[SDLK_KP_4 - SDLK_FIRST] = KC_NUMPAD4;
    keymap_sdl_to_bf[SDLK_KP_5 - SDLK_FIRST] = KC_NUMPAD5;
    keymap_sdl_to_bf[SDLK_KP_6 - SDLK_FIRST] = KC_NUMPAD6;
    keymap_sdl_to_bf[SDLK_KP_7 - SDLK_FIRST] = KC_NUMPAD7;
    keymap_sdl_to_bf[SDLK_KP_8 - SDLK_FIRST] = KC_NUMPAD8;
    keymap_sdl_to_bf[SDLK_KP_9 - SDLK_FIRST] = KC_NUMPAD9;
    ...
    keymap_sdl_to_bf[SDLK_NUMLOCKCLEAR - SDLK_FIRST] = KC_NUMLOCK;
    keymap_sdl_to_bf[SDLK_CAPSLOCK - SDLK_FIRST] = KC_CAPITAL;
    keymap_sdl_to_bf[SDLK_SCROLLLOCK - SDLK_FIRST] = KC_SCROLL;
