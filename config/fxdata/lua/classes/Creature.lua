...
---@field unsummon_turn integer Turn when the creature will unsummon. It's set on temporary creatures/familiars.
---@field familiar Creature[] list of familiars of the creature.
