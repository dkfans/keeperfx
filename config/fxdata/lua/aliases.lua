...
---@alias texture_pack integer|"NONE"|"STANDARD"|"ANCIENT"|"WINTER"|"SNAKE_KEY"|"STONE_FACE"|"VOLUPTUOUS"|"BIG_BREASTS"|"ROUGH_ANCIENT"|"SKULL_RELIEF"|"DESERT_TOMB"|"GYPSUM"|"LILAC_STONE"|"SWAMP_SERPENT"|"LAVA_CAVERN"|"LATERITE_CAVERN"
---@alias creature_property "BLEEDS"|"UNAFFECTED_BY_WIND"|"IMMUNE_TO_GAS"|"HUMANOID_SKELETON"|"PISS_ON_DEAD"|"FLYING"|"SEE_INVISIBLE"|"PASS_LOCKED_DOORS"|"SPECIAL_DIGGER"|"ARACHNID"|"DIPTERA"|"LORD"|"SPECTATOR"|"EVIL"|"NEVER_CHICKENS"|"IMMUNE_TO_BOULDER"|"NO_CORPSE_ROTTING"|"NO_ENMHEART_ATTCK"|"TREMBLING_FAT"|"FEMALE"|"INSECT"|"ONE_OF_KIND"|"NO_IMPRISONMENT"|"IMMUNE_TO_DISEASE"|"ILLUMINATED"|"ALLURING_SCVNGR"|"NO_RESURRECT"|"NO_TRANSFER"|"TREMBLING"|"FAT"|"NO_STEAL_HERO"|"PREFER_STEAL"|"EVENTFUL_DEATH"|"DIGGING_CREATURE"|"NO_HEALTH_FLOWER"|"CANNOT_PICK_UP"|"DROP_ON_PATH"|"CANNOT_POSSESS"
...
---@alias hit_type "None"|"CreaturesAndObjects"|"CreaturesOnly"|"CreaturesAndObjectsNotOwn"|"CreaturesOnlyNotOwn"|"CreaturesNotArmourNotOwn"|"All"|"HeartOnly"|"HeartOnlyNotOwn"|"CreaturesAndObjectsAndShots"|"TrapsAll"|"CreaturesOnlyOwn"
