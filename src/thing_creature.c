...
TbBool load_swipe_graphic_for_creature(const struct Thing *thing)
{
    ...
    strcpy(dat_fname, prepare_file_fmtpath_m(FGrp_StdData, AltDir_Campaign, "swipe%02d-32.dat", swpe_idx));
    strcpy(tab_fname, prepare_file_fmtpath_m(FGrp_StdData, AltDir_Campaign, "swipe%02d-32.tab", swpe_idx));
#else
    strcpy(dat_fname, prepare_file_fmtpath_m(FGrp_StdData, AltDir_Campaign, "swipe%02d.dat", swpe_idx));
    strcpy(tab_fname, prepare_file_fmtpath_m(FGrp_StdData, AltDir_Campaign, "swipe%02d.tab", swpe_idx));
#endif
