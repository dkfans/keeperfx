...
{
    return !creature_affected_by_call_to_arms(creatng) && !player_uses_power_obey(creatng->owner) && !creature_affected_by_spell(creatng, SplK_Chicken) && !thing_is_picked_up(creatng) && !is_thing_directly_controlled(creatng);
}
